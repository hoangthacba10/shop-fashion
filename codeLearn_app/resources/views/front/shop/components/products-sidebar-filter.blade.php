<form action="{{ request()->segment(2) == 'product' ? 'shop' : '' }}" method="GET">
    ...
    <div class="filter-widget">
        ...
        <div class="filter-range-wrap">
            ...
            <div class="price-range ui-slider ui-corner-all ui-silder-horizontal ui-widget ui-widget-content"
                data-min="10" data-max="999"
                data-min-value="{{ str_replace('$', '', request('price_min')) }}"
                data-max-value="{{ str_replace('$', '', request('price_max')) }}">
                    <div class="ui-slider-range ui-corner-all ui-widget-header"></div>
                    <span class="ui-slider-handle ui-corner-all ui-state-default" tabindex="0"></span>
                    <span class="ui-slider-handle ui-corner-all ui-state-default" tabindex="0"></span>
                </div>
        </div>
